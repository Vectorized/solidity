 ...
 * Optimizer: Introduced an optimized map for computing StackSlot multiplicity to improve the performance of Yul optimizer steps that involve stack shuffling.
